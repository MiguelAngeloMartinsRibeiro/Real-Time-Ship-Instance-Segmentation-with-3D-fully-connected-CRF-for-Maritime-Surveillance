...
BLENDERCLASSES = ('boat',)
BLENDERCLASSESINSTANCE = ('boat', 'vessel',)
...
ActualDataset = dataset_base.copy({
    'name': 'BlenderSet550',

    'train_images': './data/datasets/Airbus/Train/',
    'train_info':   './data/datasets/ExperienceA-2ndTime/ExperienceA15%.json',

    'valid_images': './data/datasets/TestSets/k1/',
    'valid_info':   './data/datasets/TestSets/k1.json',

    'has_gt': True,

    'class_names': BLENDERCLASSES,

    'label_map': None#COCO_LABEL_MAP
})
...
coco_base_config = Config({
    ...
    'num_classes': len(ActualDataset.class_names) + 1,
    ...
    'gamma': 0.1,
    #(- 0.35 - 0.75 - 0.875 - 0.9375) max iteration * this numer and round to multiples of 10000 with batch_size = 6 2875
    'lr_steps': (40250, 86250, 100625, 109250, 112125), #######################################################################
    ...
    'discard_box_width': 1 / 550,
    'discard_box_height': 1 / 550,
...
yolact_base_config = coco_base_config.copy({
    ...
    # Training params (- 0.35 - 0.75 - 0.875 - 0.9375) max iteration * this numer and round to multiples of 10000 with batch_size = 6
    'lr_steps': (40250, 86250, 100625, 109250, 112125),    
    'max_iter': 115000,                             
