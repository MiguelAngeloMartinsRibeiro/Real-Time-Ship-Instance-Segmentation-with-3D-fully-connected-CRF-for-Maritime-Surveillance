...
cdef extern from "densecrf/include/densecrf.h":
    ...
    cdef cppclass c_DenseCRF3D "DenseCRF3D" (c_DenseCRF):
        c_DenseCRF3D(int W, int H, int Z, int M) except +

        void addPairwiseGaussian(float sx, float sy, float sz, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral1Mod(float sx, float sy, float sz, float sMod1, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral2Mod(float sx, float sy, float sz, float sMod1, float sMod2, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral3Mod(float sx, float sy, float sz, float sMod1, float sMod2, float sMod3, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral4Mod(float sx, float sy, float sz, float sMod1, float sMod2, float sMod3, float sMod4, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral5Mod(float sx, float sy, float sz, float sMod1, float sMod2, float sMod3, float sMod4, float sMod5, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
